...
The update command SHALL update OnSpec instruction files to the latest templates.
...
- Update the OnSpec-managed block in `CLAUDE.md` using markers
  - Preserve user content outside markers
  - Create `CLAUDE.md` if missing
- Display ASCII-safe success message: "Updated OnSpec instructions"
...
- Display error: "No OnSpec directory found. Run 'openspec init' first."
- Exit with code 1
...
- Update only the OnSpec-managed block in `CLAUDE.md` using markers
