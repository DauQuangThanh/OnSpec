...
- [x] 1.5 Display ASCII-safe success message: `Updated OnSpec instructions`

## 2. CLI Integration
- [x] 2.1 Register `update` command in `src/cli/index.ts`
- [x] 2.2 Add command description: `Update OnSpec instruction files`
...
- [x] 3.2 Verify `CLAUDE.md` OnSpec block updates without altering user content outside markers
