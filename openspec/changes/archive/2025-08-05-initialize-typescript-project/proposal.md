...
## Why
The OnSpec project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up OnSpec file structures and keep AI instructions updated.
