...
## 2. Template Files
- [x] 2.1 Create src/core/templates/readme-template.ts with OnSpec README content
...
- [x] 4.3 Add validation for existing OnSpec directories with helpful error message
