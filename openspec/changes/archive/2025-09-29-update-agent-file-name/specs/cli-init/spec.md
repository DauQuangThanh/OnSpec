...
- **THEN** generate `AGENTS.md` containing complete OnSpec instructions for AI assistants
...
- **THEN** create new file with OnSpec content wrapped in markers including reference to `@openspec/AGENTS.md`
