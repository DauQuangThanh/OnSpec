/**
 * Qwen Code configurator for OnSpec integration.
 * This class handles the configuration of Qwen Code as an AI tool within OnSpec.
 * 
 ...
 * Currently configures the QWEN.md file with OnSpec instructions.
 */
export class QwenConfigurator implements ToolConfigurator {
   ...
   * with OnSpec instructions and markers.
   * 
