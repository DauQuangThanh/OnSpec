 ...
 * 
 * Configures OnSpec integration for Qoder AI coding assistant.
 * Creates and manages QODER.md configuration file with OnSpec instructions.
 * 
...
export class QoderConfigurator implements ToolConfigurator {
   ...
   * 
   * Creates or updates QODER.md file with OnSpec instructions.
   * Uses Claude-compatible template for instruction content.
   * Wrapped with OnSpec markers for future updates.
   * 
  ...
  async configure(projectPath: string, openspecDir: string): Promise<void> {
    ...
    // This ensures Qoder receives the same high-quality OnSpec instructions
